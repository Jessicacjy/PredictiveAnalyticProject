# load in data
trainset = read.csv('trainset_resampled_noinfluential_standardized.csv')
testset = read.csv('testset_standardized.csv')
...
write.csv(logitpredict,'logitpredict_targetL5_diagonsed_full.csv')

#pickle the model
save(donate.cvregmodel,file='logitpredict_targetL10_diagonsed_full.rda')
...
write.csv(df,'P_NewLogisticModel.csv')
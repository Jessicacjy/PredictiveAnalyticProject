# load in data
trainset = read.csv('trainset_standardized.csv')
...
write.csv(resample,'trainset_resampled_noinfluential_standardized.csv')
write.csv(excludelistID,'influentialID_in_resample.csv')
...
write.csv(lmtrainset,'trainset_multilinear_noinfluentialnoimputed_standardized.csv')
write.csv(excludelistID_lm,'influentialID_noimputed_multilinear.csv')

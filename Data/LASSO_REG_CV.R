# load in data
trainset = read.csv('trainset_multilinear_noinfluentialnoimputed_standardized.csv')
...
write.csv(regpredict,'regpredict_diagnosed_fullmodel2.csv')

#pickle the model
save(donate.cvregmodel,file='reg_diagnosed_full2.rda')
